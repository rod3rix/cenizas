...
<section class="jumbotron text-center">
        <div class="container">
          ...
          <p>
            <a href="https://comunidades.cenizas.cl/usuariosRegistrados" class="btn btn-secondary my-3">VER USUARIOS</a>
            <a href="https://comunidades.cenizas.cl/verPostulacionesFondos" class="btn btn-secondary my-3">VER POSTULACIONES FONDOS CONCURSABLES</a>
            <a href="https://comunidades.cenizas.cl/verPostulacionesProyectos" class="btn btn-secondary my-3">VER POSTULACIONES APOYO PROYECTOS</a>
            <a href="https://comunidades.cenizas.cl/verSugerenciaReclamo" class="btn btn-secondary my-3">VER CASOS</a>
          </p>
        </div>
@if(auth::user()->rol=="1")
