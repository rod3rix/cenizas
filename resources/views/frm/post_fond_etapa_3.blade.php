         ...
         <div class="card">
           ...
           <div class="form-group row">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-12">
                        <input id="cierre_proyecto" type="cierre_proyecto" class="form-control" name="cierre_proyecto" value="{{ old('cierre_proyecto') }}" required autocomplete="cierre_proyecto">
                     </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                      <label class="col-md-12 col-form-label text-md-left">{{ __('10. Presupuesto:') }}</label><label for="rec_humanos" class="col-md-2 col-form-label text-md-left">{{ __('Recursos Humanos') }}</label>
                      <div class="col-md-10">
                        <input id="rec_humanos" type="text" class="miles form-control" name="rec_humanos" value="{{ old('rec_humanos') }}" required autocomplete="rec_humanos"  placeholder="$" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="12" onpaste="handlePaste(event)">
                     </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-10">
                        <input id="mat_insumos" type="text" class="miles form-control" name="mat_insumos" value="{{ old('mat_insumos') }}" required autocomplete="mat_insumos"  placeholder="$" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="12" onpaste="handlePaste(event)">
                     </div>
                  </div>
                  <div class="form-group row">
                      <label for="otros" class="col-md-2 col-form-label text-md-left">{{ __('Otros') }}</label>
                      <div class="col-md-10">
                        <input id="otros" type="text" class="miles form-control" name="otros" value="{{ old('otros') }}" required autocomplete="otros"  placeholder="$" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="12" onpaste="handlePaste(event)">
                     </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-10">
                        <input id="aporte_terceros" type="text" class="miles form-control" name="aporte_terceros" value="{{ old('aporte_terceros') }}" required autocomplete="aporte_terceros"  placeholder="$" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="12" onpaste="handlePaste(event)">
                     </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-10">
                        <input id="aporte_propio" type="text" class="miles form-control" name="aporte_propio" value="{{ old('aporte_propio') }}" required autocomplete="aporte_propio"  placeholder="$" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="12" onpaste="handlePaste(event)">
                     </div>
                  </div>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-10">
                        <input id="total" type="text" class="miles form-control" name="total" value="{{ old('total') }}" autocomplete="total"  placeholder="$" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="12" onpaste="handlePaste(event)" readonly>
                     </div>
                  </div>
