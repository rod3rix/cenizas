                  ...
                  <div class="form-group row">
                     <div class="col-md-12">
                        <div class="form-check form-check-inline">
                          ...
                          <label class="form-check-label" for="acepto_clausula"><a href="{{ route('clausulaProyecto') }}">Acepto cláusula de tratamiento de información personal *</a><br> Marcar casilla para aceptar cláusula..</label>
