...
class RegionesComunasSeeder extends Seeder
{
    public function run()
    {
        ...
        $regiones = [
            ...
            'Región del Maule' => [
                'Talca', 'ConsVtución', 'Curepto', 'Empedrado', 'Maule', 'Pelarco', 'Pencahue', 'Río Claro', 'San Clemente', 'San Rafael', 'Cauquenes', 'Chanco', 'Pelluhue', 'Curicó', 'Hualañé', 'Licantén', 'Molina', 'Rauco', 'Romeral', 'Sagrada Familia', 'Teno', 'Vichuquén', 'Linares', 'Colbún', 'Longaví', 'Parral', 'Retiro', 'San Javier', 'Villa Alegre', 'Yerbas Buenas'
            ],
            'Región de Ñuble' => [
                'Chillán', 'Bulnes', 'Chillán Viejo', 'El Carmen', 'Pemuco', 'Pinto', 'Quillón', 'San Ignacio', 'Yungay', 'Cobquecura', 'Coelemu', 'Ninhue', 'Portezuelo', 'Quirihue', 'Ránquil', 'Treguaco'
            ],
            'Región del Biobío' => [
        ...
        foreach ($regiones as $nombreRegion => $comunas) {
            $region = Regiones::create(['nombre' => $nombreRegion]);

            foreach ($comunas as $nombreComuna) {
                Comunas::create(['nombre' => $nombreComuna, 'region_id' => $region->id]);
            }
        }
    }
}
